...
![The extraction workflow: what runs, what it is checked against, and what it leaves behind](workflow.png)
...
The figure is generated by `R/reporting/figure_workflow.R`, so it cannot quietly
